## Intro to Functional Programming resource
	Link: [go to resource](https://cs.uwaterloo.ca/~plragde/flaneries/?fbclid=IwAR33nls3oQnAxUVT2b2AU4-KFcHG1tp3Wq1cmD_9fEXe2lUPSYgYIuwnRVU)
	Description: Introduction  to functional programming and all of it's internals


## Intro to Compilers
	Link: [go to resource](https://www.youtube.com/watch?v=W9B98S2mGGE&list=PL6KMWPQP_DM97Hh0PYNgJord-sANFTI3i)
...
## Intro to Operating Systems
	Link: [go to resource](https://pages.cs.wisc.edu/~remzi/OSTEP/)
...
## Catalogue for general CS resources by Joren Garenar
	Link: [go to resource](https://resources.joren.ga/)
